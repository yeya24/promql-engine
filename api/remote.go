...
type RemoteEndpoints interface {
	Engines(userID string, query string, start, end time.Time) []RemoteEngine
}
...
func (m staticEndpoints) Engines(userID, query string, start, end time.Time) []RemoteEngine {
	return m.engines
}
